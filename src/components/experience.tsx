...
const Experience = () => {
  ...
  return (
      ...
      >
        ...
        <Reveal classList="w-full h-full flex flex-col justify-center items-center">
          <h2 className="scroll-m-20 sm:text-[6vw] text-[2.5rem] font-extrabold tracking-tight h-fit text-secondary">Experience</h2>
          <ol className="border-l border-neutral-300 dark:border-neutral-500 m-5 lg:w-1/2">
            <Accordion type="single" collapsible onValueChange={onChange}>
              <AccordionItem value="item-1" className={`border-none ${active === "item-1" && "bg-secondary rounded-lg ml-2 p-2"}`}>
                <AccordionTrigger className={`w-full ${active === "item-1" ? "text-primary" : "text-secondary"}`}>
                  <div className="w-full">
                    <div className="flex-start flex items-center pt-2">
                      <div className={`${active === "item-1" ? "-ml-[21px]" : "-ml-[5px]"} mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500`}></div>
              ...
              <AccordionItem value="item-2" className={`border-none ${active === "item-2" && "bg-secondary rounded-lg ml-2 p-2"}`}>
                <AccordionTrigger className={`w-full ${active === "item-2" ? "text-primary" : "text-secondary"}`}>
                  <div className="w-full">
                    <div className="flex-start flex items-center pt-2">
                      <div className={`${active === "item-2" ? "-ml-[21px]" : "-ml-[5px]"} mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500`}></div>
