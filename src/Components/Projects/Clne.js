  ...
  return (
    <div className='m-5'>
      <Grid templateColumns='repeat(3, 1fr)' alignItems="center">
        <Breadcrumb>
          <BreadcrumbItem>
            <BreadcrumbLink onClick={() => {window.location.href = "/#projects" }}><Text color={useColorModeValue("purple.300", "blue.400")}>Projects</Text></BreadcrumbLink>
          </BreadcrumbItem>
      ...
      <Heading as='h3' size='lg'>What is Clne?</Heading>
